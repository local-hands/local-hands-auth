...
using LocalHandsAuth.ServiceProvider;
...
public class Startup(IConfiguration configuration)
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddSingleton<IDbServiceProvider>(sp =>
          new DbServiceProvider(sp.GetService<IMongoDatabase>() ?? throw new Exception("IMongoDatabase not found"))
        );
